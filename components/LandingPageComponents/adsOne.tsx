...
export default function AdsOne() {
  return (
    <section className="relative w-full h-[560px] px-[96px] rounded-lg bg-[var(--main-orange)]  flex items-center overflow-hidden">
      ...
      {/* === Speaker Image === */}
      <div className="relative z-10 flex-shrink-0 w-[410px] h-[490px] -translate-y-10 md:-translate-y-12 md:-ml-8">
        <Image
          src={speakerOneImage}
          alt="ZX9 Speaker"
          fill
      ...
      <div className="flex flex-col items-start justify-center text-white ml-[200px] z-20">
        ...
        <button className="bg-black hover:bg-black/90 text-white font-semibold px-8 py-6 text-sm tracking-widest uppercase">
          See Product
        </button>
      </div>
    </section>
